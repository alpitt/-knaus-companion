const CACHE='knaus-companion-v12-8-0-heating-history';
const CORE=['./','./index.html','./manifest.webmanifest','./assets/css/app-v4.css?v=12.8.0-heating-history','./assets/js/app-v4.js?v=12.8.0-heating-history','./data/build.json','./data/vehicle_config_schema.json','./data/touring_operations.json','./data/packing_templates.json','./data/maintenance_tasks.json','./data/parts_inventory.json','./assets/photos/vehicle_photo_01.jpg','./assets/photos/vehicle_photo_02.jpg','./assets/photos/vehicle_photo_03.jpg','./assets/photos/vehicle_photo_04.jpg','./assets/photos/vehicle_photo_05.jpg','./assets/photos/vehicle_photo_06.jpg'];
