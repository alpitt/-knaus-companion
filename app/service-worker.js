const CACHE='knaus-companion-v14-0-0-engineering-corpus';
const CORE=['./','./index.html','./manifest.webmanifest','./assets/css/app-v4.css?v=14.0.0-engineering-corpus','./assets/js/kb-corpus.js?v=14.0.0-engineering-corpus','./assets/js/app-v4.js?v=14.0.0-engineering-corpus','./data/build.json','./data/kb_manifest.json','./data/kb_index.json','./data/vehicle_config_schema.json','./data/touring_operations.json','./data/packing_templates.json','./data/maintenance_tasks.json','./data/parts_inventory.json','./assets/photos/vehicle_photo_01.jpg','./assets/photos/vehicle_photo_02.jpg','./assets/photos/vehicle_photo_03.jpg','./assets/photos/vehicle_photo_04.jpg','./assets/photos/vehicle_photo_05.jpg','./assets/photos/vehicle_photo_06.jpg'];
