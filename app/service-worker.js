const CACHE='knaus-companion-v4-4-0-fuses';
const CORE=['./','./index.html','./manifest.webmanifest','./assets/css/app-v4.css?v=4.4.0-fuses','./assets/js/app-v4.js?v=4.4.0-fuses','./data/build.json'];
