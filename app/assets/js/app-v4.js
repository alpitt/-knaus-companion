...
async function init(){
  ...
  window.KnausChangePlans?.initialise(ownerAdapter);window.KnausWorkshopJobs?.initialise(ownerAdapter);window.KnausInspections?.initialise(ownerAdapter,{templates:DATA.inspectionTemplates||[]});window.KnausTrips?.initialise(ownerAdapter);
  ...
  window.KnausChangePlannerUI?.initialise({toast});window.KnausWorkshopJobsUI?.initialise({toast});window.KnausTripsUI?.initialise({toast});
