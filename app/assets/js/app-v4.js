...
function setActiveRoute(id){
  ...
  if(id==="refrigeration")renderRefrigeration();
...
async function init(){
  ...
  applyTheme();renderNav();renderHome();renderAssistant();renderLibrary();renderMaintenance();renderCompliance();renderEmergency();renderSeasonal();renderDiagnostics();renderTouring();renderVehicle();renderElectrical();renderFuses();renderWater();renderGas();renderHeating();renderRefrigeration();renderWorkshop();renderSettings();
