...
async function init(){
  ...
  window.KnausChangePlans?.initialise(ownerAdapter);window.KnausWorkshopJobs?.initialise(ownerAdapter);window.KnausInspections?.initialise(ownerAdapter,{templates:DATA.inspectionTemplates||[]});window.KnausTrips?.initialise(ownerAdapter);window.KnausMaintenanceEngine?.initialise(ownerAdapter);window.KnausMaintenanceCampaigns?.initialise(ownerAdapter);window.KnausMaintenanceParts?.initialise(ownerAdapter);window.KnausMaintenanceConsumables?.initialise(ownerAdapter);
