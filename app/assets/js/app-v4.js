...
async function init(){
  ...
  window.KnausChangePlans?.initialise(ownerAdapter);window.KnausWorkshopJobs?.initialise(ownerAdapter);window.KnausInspections?.initialise(ownerAdapter,{templates:DATA.inspectionTemplates||[]});
  ...
  window.KnausChangePlannerUI?.initialise({toast});window.KnausWorkshopJobsUI?.initialise({toast});
