...
const NAV=[
  ["procedures","Procedure Library","▦"],["procedure-run","Guided Procedures","▶"],["technical-library","Technical Library","⌘"],
...
function applicationRecordCounts(){return{maintenancePlans:(state.maintenancePlans||[]).length,changePlans:(state.changePlans||[]).length,workshopJobs:(state.workshopJobs||[]).length,inspections:(state.inspections||[]).length,service:(state.logs||[]).length,faults:(state.faults||[]).length,measurements:(state.electricalMeasurements||[]).length,trips:(state.trips||[]).length,documents:(state.vehicleDocuments||[]).length,photos:Object.keys(state.vehiclePhotoNotes||{}).length,assistant:(state.assistantHistory||[]).length,ownerRecords:(state.ownerRecords||[]).length,evidenceRecords:(state.evidenceLibrary||[]).length,evidenceLinks:(state.evidenceLinks||[]).length,revisions:(state.ownerRecords||[]).reduce((sum,record)=>sum+(record.history?.length||0),0)+(state.evidenceLibrary||[]).reduce((sum,record)=>sum+(record.revisionHistory?.length||0),0)}}
