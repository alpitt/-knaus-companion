...
const DEFAULT_STATE={schemaVersion:2,theme:"light",logs:[],maintenance:{},maintenancePlans:[],maintenanceCampaigns:[],maintenanceParts:[],maintenanceConsumables:[],maintenanceWarranties:[],departure:{},touringProgress:{},seasonalProgress:{},seasonalPlans:{},seasonalSupplies:{},seasonalCustomTasks:[],seasonalCycles:[],electricalMeasurements:[],heatingProfile:{},heatingReadiness:{},heatingRuns:[],heatingServiceSchedule:{},heatingServiceHistory:[],refrigerationProfile:{},refrigerationReadiness:{},refrigerationRuns:[],workshopSteps:{},activeWorkshopSession:null,workshopSessions:[],trips:[],expenses:[],savedCampsites:[],packingLists:[],payloadPlan:{},ownershipBudget:{},ownershipCommitments:[],complianceRequirements:[],emergencyContacts:[],emergencyIncidents:[],emergencyReadiness:{},emergencyDrills:[],emergencyEquipment:[],emergencyNotes:"",vehicleProfile:{make:"Knaus",model:"Sun Traveller"},vehicleConfiguration:{},vehicleDocuments:[],upgradeProjects:[],changePlans:[],workshopJobs:[],inspections:[],vehiclePhotoNotes:{},partsStock:{},currentMileage:0,faults:[],ownerRecords:[],evidenceLinks:[],evidenceLibrary:[],inventory:[],assistantHistory:[],manualBookmarks:[],manualOcrVisible:false,diagnosticReports:[],ownershipProfiles:[],ownershipCosts:[],ownershipProvenanceLinks:[],vehicleHealthSnapshots:[],procedures:[],procedureExecutions:[],procedureDeviations:[],lessonsLearned:[],procedureRevisionProposals:[],knowledgeRelationships:[],diagnostics:[],diagnosticSessions:[],diagnosticObservations:[],diagnosticMeasurements:[],diagnosticEscalations:[],diagnosticUnresolvedQuestions:[],diagnosticRootCauses:[],diagnosticResolutions:[],diagnosticDeviations:[]};
...
const REFRIGERATION_COMPONENTS=[
  {id:"fridge-control",view:"control",name:"Refrigerator control",category:"User control",status:"Confirm fitted model",location:"Refrigerator fascia",purpose:"Selects operating mode, energy source and cooling demand where supported.",operation:"Follow the instructions for the fitted refrigerator; controls vary by model.",checks:["Confirm the display powers up without a persistent fault indication.","Record the selected mode and any code before resetting."],routes:["electrical","gas"]},
  {id:"fridge-12v",view:"energy",name:"12 V control supply",category:"Electrical input",status:"Protected supply required",location:"Habitation distribution and refrigerator wiring",purpose:"Powers electronic control and may support cooling while driving on compatible installations.",operation:"Engine-running interlocks and wiring vary; do not assume 12 V cooling is available when parked.",checks:["Check habitation voltage and the documented refrigerator fuse.","Use the Fuse Finder before replacing any fuse."],routes:["electrical","fuses"]},
  {id:"fridge-230v",view:"energy",name:"230 V mains supply",category:"Electrical input",status:"Confirm supported mode",location:"Refrigerator socket or fixed connection",purpose:"Provides mains energy for cooling when connected to a suitable supply.",operation:"The vehicle mains protection and refrigerator circuit must both be healthy.",checks:["Confirm other mains appliances indicate a valid hookup.","Stop if plugs, sockets or cables show heat damage."],routes:["electrical","workshop"]},
  {id:"fridge-gas",view:"energy",name:"LPG appliance supply",category:"Fuel input",status:"Confirm absorption refrigerator",location:"Gas manifold to refrigerator burner",purpose:"Provides LPG only where the fitted refrigerator supports gas operation.",operation:"Gas isolation, ignition and combustion require an unobstructed external flue path.",checks:["Stop immediately if gas smell or abnormal combustion is suspected.","Do not dismantle burner, jet or gas valve components."],routes:["gas","emergency"]},
  {id:"fridge-cooling",view:"cooling",name:"Cooling unit",category:"Heat transfer",status:"Appliance integrated",location:"Rear of refrigerator",purpose:"Removes heat from the food compartment using the fitted refrigeration process.",operation:"Vehicle levelling, ambient temperature and ventilation can affect absorption-fridge performance.",checks:["Allow adequate stabilisation time before judging temperature.","Keep rear appliance space free from stored items."],routes:["vehicle","workshop"]},
  {id:"fridge-cabinet",view:"cooling",name:"Food compartment",category:"Cold storage",status:"User accessible",location:"Interior refrigerator cabinet",purpose:"Retains cooled food and provides the observable temperature result.",operation:"Door opening, warm contents and thermostat setting affect pull-down time.",checks:["Check the door closes fully and shelves do not obstruct internal airflow.","Use a separate fridge thermometer to verify temperature."],routes:["vehicle"]},
  {id:"fridge-seal",view:"cooling",name:"Door seal",category:"Thermal boundary",status:"User inspectable",location:"Refrigerator door perimeter",purpose:"Limits warm-air and moisture entry into the cabinet.",operation:"A clean, continuous seal supports stable cooling and reduces condensation.",checks:["Inspect for dirt, folds, splits or gaps.","Clean only with materials suitable for the fitted seal."],routes:["maintenance"]},
  {id:"fridge-vents",view:"ventilation",name:"Exterior refrigerator vents",category:"Heat rejection",status:"Must remain clear",location:"Exterior lower and upper vents",purpose:"Admits cooling air and rejects heat from the rear appliance space.",operation:"Covers, nests, debris or stored items can seriously reduce performance.",checks:["Remove travel or winter covers when operation requires open vents.","Inspect externally for obstruction without reaching into live appliance space."],routes:["vehicle","seasonal"]},
  {id:"fridge-flue",view:"safety",name:"Combustion flue",category:"Safety boundary",status:"Gas models only",location:"Rear appliance space to exterior termination",purpose:"Discharges combustion products when a compatible refrigerator runs on LPG.",operation:"The flue and fixed ventilation must remain intact and unobstructed.",checks:["Stop use if soot, staining, fumes or heat damage is visible.","Combustion servicing requires a competent technician."],routes:["gas","emergency"]}
];
const REFRIGERATION_RELATIONS=[["fridge-control","fridge-12v","uses control power"],["fridge-control","fridge-230v","selects mains where supported"],["fridge-control","fridge-gas","selects LPG where supported"],["fridge-12v","fridge-cooling","may supply energy"],["fridge-230v","fridge-cooling","supplies energy"],["fridge-gas","fridge-cooling","supplies heat"],["fridge-cooling","fridge-cabinet","removes cabinet heat"],["fridge-seal","fridge-cabinet","retains cold air"],["fridge-vents","fridge-cooling","rejects heat"],["fridge-gas","fridge-flue","discharges combustion products"]];
const REFRIGERATION_READINESS_ITEMS=[
  {id:"level",title:"Vehicle suitably level",detail:"The parked attitude is within the fitted refrigerator's operating guidance.",route:"vehicle"},
  {id:"vents",title:"Exterior vents clear",detail:"Required covers are removed and both ventilation openings are unobstructed.",route:"seasonal"},
  {id:"energy",title:"Energy mode confirmed",detail:"The selected supported energy source is available with no warning signs.",route:"refrigeration"},
  {id:"seal",title:"Door and seal ready",detail:"The door closes fully and the seal is clean, continuous and undamaged.",route:"maintenance"},
  {id:"cooldown",title:"Cool-down time allowed",detail:"Adequate stabilisation time has elapsed before performance is judged.",route:"refrigeration"},
  {id:"temperature",title:"Cabinet temperature verified",detail:"A separate refrigerator thermometer confirms a suitable food-storage temperature.",route:"refrigeration"}
];
...
let electricalMeasurementFilter="all";
...
let heatingRunFilter="all";
let refrigerationFilter="all";
let activeRefrigerationComponent="fridge-control";
let refrigerationRunFilter="all";
...
function normaliseEvidence(value,fallbackStatus="unknown"){
  const input=value&&typeof value==="object"&&!Array.isArray(value)?value:{value,status:fallbackStatus};
  return {value:input.value??"",status:EVIDENCE_STATUSES[input.status]?input.status:fallbackStatus,source:String(input.source||""),lastVerified:String(input.lastVerified||""),notes:String(input.notes||"")};
}
function evidenceValue(value){return normaliseEvidence(value).value}
function migrateEvidenceState(input={}){
  const incoming=input&&typeof input==="object"&&!Array.isArray(input)?input:{},configuration=incoming.vehicleConfiguration&&typeof incoming.vehicleConfiguration==="object"&&!Array.isArray(incoming.vehicleConfiguration)?incoming.vehicleConfiguration:{},migrated={};
  Object.entries(configuration).forEach(([key,value])=>{migrated[key]=normaliseEvidence(value)});
...
function setActiveRoute(id){
  ...
  if(id==="systems")window.KnausSystemExplorer?.render();
  if(id==="change-plans")window.KnausChangePlannerUI?.render();
  if(id==="workshop-jobs")window.KnausWorkshopJobsUI?.render();
  if(id==="inspections")window.KnausWorkshopJobsUI?.renderInspections();
  if(id==="workshop-job")window.KnausWorkshopJobsUI?.renderExecution(location.hash.split("/")[1]);
  if(id==="trips")window.KnausTripsUI?.render();
  if(id==="trip-dashboard")window.KnausTripsUI?.renderDashboard(location.hash.split("/")[1]);
  if(id==="maintenance-intelligence")window.KnausMaintenanceIntelligenceUI?.render();
  if(id==="maintenance-dashboard")window.KnausMaintenanceIntelligenceUI?.renderDashboard();
  if(id==="maintenance-calendar")window.KnausMaintenanceIntelligenceUI?.renderCalendar();
  if(id==="ownership")window.KnausOwnershipIntelligenceUI?.render();
  if(id==="ownership-timeline")window.KnausOwnershipIntelligenceUI?.renderTimeline();
  if(id==="ownership-costs")window.KnausOwnershipIntelligenceUI?.renderCosts();
  if(id==="provenance")window.KnausOwnershipIntelligenceUI?.renderProvenance();
  if(id==="procedures")window.KnausProcedureUI?.render();
  if(id==="procedure-run")window.KnausProcedureUI?.renderRun();
  if(id==="technical-library")window.KnausProcedureUI?.renderLibrary();
  if(id==="diagnostics")window.KnausDiagnosticUI?.render();
  if(id==="diagnostic-run")window.KnausDiagnosticUI?.renderRun();
  if(id==="records")window.KnausOwnerRecordUI?.render();
  if(id==="evidence")window.KnausEvidenceLibraryUI?.render();
  if(id==="timeline")window.KnausOwnerRecordUI?.renderTimeline();
  if(id==="health"){renderHealth();renderOwnerRecordHealth()}
  renderBreadcrumb(id);
...
const NAV=[
  ["procedures","Procedure Library","▦"],["procedure-run","Guided Procedures","▶"],["technical-library","Technical Library","⌘"],["diagnostic-run","Guided Diagnostics","?"],
  ["workshop-jobs","Workshop Jobs","W"],["inspections","Inspections","I"],["ownership","Ownership Intelligence","£"],["ownership-timeline","Ownership Timeline","◷"],["ownership-costs","Ownership Costs","¤"],["provenance","Provenance Explorer","↔"],
  ["change-plans","Change Planner","+"],
  ["home","Home","⌂"],["assistant","Assistant","✦"],["search","Search","⌕"],["manuals","Manuals & chapters","▤"],["canon","Engineering Canon","⌘"],["digital-twin","Digital Twin","◎"],
    ["systems","Systems Explorer","⌘"],["records","Vehicle records","✎"],["evidence","Evidence Library","▧"],["timeline","Vehicle timeline","◷"],["maintenance","Service & maintenance","⚙"],["maintenance-intelligence","Maintenance Intelligence","◫"],["compliance","Compliance centre","🛡"],["emergency","Emergency centre","☎"],["seasonal","Seasonal care","❄"],["diagnostics","Diagnostics","✓"],["electrical","Electrical system","⚡"],["fuses","Fuse finder","▥"],["water","Water system","💧"],["gas","Gas system","🔥"],["heating","Heating system","♨"],["refrigeration","Refrigeration","❄"],["workshop","Workshop mode","🛠"],["trips","Trip readiness","➜"],["touring","Touring","➜"],["vehicle","My motorhome","▣"],["health","Application health","●"],["settings","Settings","⋯"]
];
function renderNav(){
...
function dashboardAlerts(){
  ...
  const latestHeatingRun=[...(state.heatingRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)))[0];if(latestHeatingRun&&latestHeatingRun.result!=="normal")alerts.push({priority:latestHeatingRun.result==="action"?1:3,kind:latestHeatingRun.result==="action"?"urgent":"warning",icon:"♨",title:latestHeatingRun.result==="action"?"Heating test needs action":"Heating test needs monitoring",detail:[formatTripDate(latestHeatingRun.date),latestHeatingRun.faultCode,latestHeatingRun.notes].filter(Boolean).join(" • "),route:"heating"});
  const heatingService=heatingServiceStatus();if(heatingService.status==="overdue")alerts.push({priority:1,kind:"urgent",icon:"♨",title:"Heating service overdue",detail:`Due ${formatTripDate(heatingService.nextDue)}`,route:"heating"});else if(heatingService.status==="due")alerts.push({priority:2,kind:"warning",icon:"♨",title:"Heating service due soon",detail:`Due ${formatTripDate(heatingService.nextDue)}`,route:"heating"});
  const latestRefrigerationRun=[...(state.refrigerationRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)))[0];if(latestRefrigerationRun&&latestRefrigerationRun.result!=="normal")alerts.push({priority:latestRefrigerationRun.result==="action"?1:3,kind:latestRefrigerationRun.result==="action"?"urgent":"warning",icon:"❄",title:latestRefrigerationRun.result==="action"?"Refrigeration test needs action":"Refrigeration test needs monitoring",detail:[formatTripDate(latestRefrigerationRun.date),`${latestRefrigerationRun.endTemperature}°C`,latestRefrigerationRun.notes].filter(Boolean).join(" • "),route:"refrigeration"});
...
function applicationRecordCounts(){return{maintenancePlans:(state.maintenancePlans||[]).length,changePlans:(state.changePlans||[]).length,workshopJobs:(state.workshopJobs||[]).length,inspections:(state.inspections||[]).length,service:(state.logs||[]).length,faults:(state.faults||[]).length,measurements:(state.electricalMeasurements||[]).length,trips:(state.trips||[]).length,documents:(state.vehicleDocuments||[]).length,photos:Object.keys(state.vehiclePhotoNotes||{}).length,assistant:(state.assistantHistory||[]).length,ownerRecords:(state.ownerRecords||[]).length,evidenceRecords:(state.evidenceLibrary||[]).length,evidenceLinks:(state.evidenceLinks||[]).length,diagnostics:(state.diagnostics||[]).length,diagnosticSessions:(state.diagnosticSessions||[]).length,diagnosticObservations:(state.diagnosticObservations||[]).length,diagnosticMeasurements:(state.diagnosticMeasurements||[]).length,diagnosticEscalations:(state.diagnosticEscalations||[]).length,unresolvedDiagnosticQuestions:(state.diagnosticUnresolvedQuestions||[]).length,diagnosticRootCauses:(state.diagnosticRootCauses||[]).length,diagnosticResolutions:(state.diagnosticResolutions||[]).length,revisions:(state.ownerRecords||[]).reduce((sum,record)=>sum+(record.history?.length||0),0)+(state.evidenceLibrary||[]).reduce((sum,record)=>sum+(record.revisionHistory?.length||0),0)}}
function renderOwnerRecordHealth(){const records=state.ownerRecords||[],stats=window.KnausOwnerRecords?.getStatistics()||{},quality=window.KnausDigitalTwinOwnerOverlay?.getQualityReport()||{},ids=records.map(x=>x.id),duplicates=ids.length-new Set(ids).size,invalid=records.filter(record=>!window.KnausOwnerRecords?.validate(record,{knownRecordIds:ids}).valid).length,invalidDates=records.filter(record=>[record.createdAt,record.updatedAt,record.occurredAt].filter(Boolean).some(value=>Number.isNaN(Date.parse(value)))).length,invalidUnits=records.flatMap(x=>x.measurements||[]).filter(x=>!window.KnausOwnerRecords?.MEASUREMENT_UNITS.includes(x.unit)).length,historyErrors=records.filter(record=>!window.KnausRecordHistory?.validateHistory(record.history||[],record.id).valid).length,brokenEvidence=window.KnausEvidenceLinks?.getBrokenLinks({recordIds:ids})?.length||0,overdue=records.filter(x=>["maintenance","service"].includes(x.type)&&x.dueDate&&x.dueDate<new Date().toISOString().slice(0,10)&&x.status!=="completed").length,bytes=new Blob([localStorage.getItem(STORE_KEY)||""]).size,lastBackup=state.lastBackupExportedAt?new Date(state.lastBackupExportedAt).toLocaleString():"Not recorded";$("#healthOwnerRecords").innerHTML=[[stats.total||0,"Owner records"],[stats.openFaults||0,"Open faults"],[overdue,"Overdue maintenance"],[stats.missingEvidence||0,"Missing evidence"],[quality.brokenComponentReferences?.length||0,"Broken component links"],[brokenEvidence,"Broken evidence links"],[duplicates,"Duplicate IDs"],[invalidDates,"Invalid dates"],[invalidUnits,"Invalid units"],[historyErrors,"Revision errors"],[stats.archived||0,"Archived"],[`${(bytes/1024).toFixed(1)} KB`,"Local storage"],[lastBackup,"Last backup"]].map(([v,l])=>`<article class="stat-card"><strong>${esc(v)}</strong><span>${esc(l)}</span></article>`).join("");$("#healthOwnerRecordStatus").className=`panel health-check ${invalid||duplicates||historyErrors?"health-red":quality.brokenComponentReferences?.length||brokenEvidence?"health-amber":"health-green"}`;$("#healthOwnerRecordStatus").innerHTML=`<span class="health-light" aria-hidden="true"></span><div><strong>${invalid?`${invalid} structurally invalid record${invalid===1?"":"s"}`:"Owner-record structure valid"}</strong><p>Missing evidence and intentionally unknown fields are review items, not software failures.</p></div>`}
async function renderHealth(){const twin=window.KnausDigitalTwin?.getStatistics()||{},canon=window.KnausCorpus?.getStatistics()||{},reasoning=window.KnausReasoning?.getStatistics()||{},counts=applicationRecordCounts(),config=configurationSections().flatMap(x=>x.fields||[]).map(configurationEvidence),unknown=config.filter(x=>x.status==="unknown").length,confirmed=config.filter(x=>["plate-confirmed","owner-confirmed","photograph-confirmed"].includes(x.status)).length,broken=(window.KnausDigitalTwin?.getTwin()?.relationships||[]).flatMap(x=>[x.sourceId,x.targetId]).filter(id=>!window.KnausDigitalTwin.validateReference(id)).length,cacheKeys="caches" in window?await caches.keys():[],expectedCache="knaus-companion-v20-0-0-diagnostics",staleCache=cacheKeys.some(key=>key.startsWith("knaus-companion-")&&key!==expectedCache),currentCache=cacheKeys.includes(expectedCache);$("#healthSummary").innerHTML=[[APP_VERSION,"Repository version"],[state.schemaVersion||2,"Storage schema"],[reasoning.records||0,"Search evidence"],[counts.service+counts.faults+counts.measurements,"Technical records"],[confirmed,"Confirmed values"],[unknown,"Unknown values"]].map(([v,l])=>`<article class="stat-card"><strong>${esc(v)}</strong><span>${esc(l)}</span></article>`).join("");const checks=[{label:"Digital Twin",detail:`${twin.components||0} components • ${broken} broken references`,level:broken?"red":twin.components?"green":"amber"},{label:"Engineering Canon",detail:`${canon.available||0}/${canon.expected||275} records available`,level:canon.available?"green":"amber"},{label:"Evidence registry",detail:`${confirmed} confirmed • ${unknown} unknown`,level:unknown?"amber":"green"},{label:"Repository validation",detail:"Static integrity checks installed",level:"green"},{label:"Backup",detail:`Schema ${state.schemaVersion||2} • ${Object.values(counts).reduce((a,b)=>a+b,0)} local records`,level:"green"},{label:"Offline",detail:navigator.onLine?"Network available":"Currently offline",level:currentCache?"green":"amber"},{label:"Cache",detail:currentCache?(staleCache?"Current cache ready; older cache pending cleanup":"Current release cache ready"):cacheKeys.length?"Only a stale application cache was detected":"No application cache detected",level:currentCache?(staleCache?"amber":"green"):"red"}];$("#healthChecks").innerHTML=checks.map(x=>`<article class="panel health-check health-${x.level}"><span class="health-light" aria-label="${x.level==="green"?"Ready":x.level==="amber"?"Needs review":"Action required"}"></span><div><strong>${esc(x.label)}</strong><p>${esc(x.detail)}</p></div></article>`).join("");$("#healthCacheDetail").textContent=currentCache?`Active cache: ${expectedCache}`:cacheKeys.length?`Stale cache detected: ${cacheKeys.join(", ")}`:"No offline cache is currently available. Rebuild while online.";$("#healthRecordCounts").innerHTML=`<dl>${Object.entries(counts).map(([k,v])=>`<dt>${esc(k)}</dt><dd>${v}</dd>`).join("")}</dl>`}
...
function renderHome(){
  ...
  $("#homeModules").innerHTML=[
    ...
    moduleCard("records","✎","Vehicle records","Observations, faults, maintenance and modifications"),
    moduleCard("timeline","◷","Vehicle timeline","Chronological owner-record history"),
...
function assistantIndex(){
  ...
  [...(window.KnausSystemGraph?.getNodes()||[]),...(window.KnausSystemGraph?.getEdges()||[])].forEach(entity=>docs.push({type:"system graph",title:entity.name||`${entity.type}: ${entity.sourceId} → ${entity.targetId}`,text:JSON.stringify(entity),raw:entity,graphEntityId:entity.id}));
  ...
  configurationSections().flatMap(section=>section.fields||[]).forEach(field=>{const evidence=configurationEvidence(field),value=String(evidence.value??"").trim();if(value)docs.push({type:"vehicle configuration",title:field.label,text:`${value} ${EVIDENCE_STATUSES[evidence.status].label} ${evidence.source} ${evidence.notes}`,raw:evidence,evidence,field})});
  (state.electricalMeasurements||[]).forEach(item=>{const component=DATA.electrical.find(entry=>entry.id===item.componentId);docs.push({type:"electrical measurement",title:`${component?.name||"Electrical component"} — ${item.testPoint}`,text:`${item.value} ${item.unit} ${item.date} ${item.conditions} ${item.notes}`,raw:item})});
  ...
  (state.workshopJobs||[]).forEach(d=>docs.push({type:"workshop job",title:d.title||"Workshop job",text:`${d.status}. ${d.verificationResult}. Not professional certification. ${JSON.stringify(d)}`,raw:d}));
  (state.inspections||[]).forEach(d=>docs.push({type:"inspection",title:d.title||"Inspection",text:`${d.status}. ${d.result}. ${JSON.stringify(d)}`,raw:d}));
  (state.changePlans||[]).forEach(d=>docs.push({type:"proposed change plan",title:d.title||"Proposed change",text:`Proposed, not approved or current. ${JSON.stringify(d)}`,raw:d}));
...
function searchDocs(q){
  ...
  const seen=new Set();
  return assistantIndex().map(d=>{const title=String(d.title||"").toLowerCase(),text=String(d.text||"").toLowerCase(),matched=terms.filter(term=>title.includes(term)||text.includes(term)),allTerms=matched.length===terms.length,exactTitle=title===terms.join(" "),titleMatches=matched.filter(term=>title.includes(term)).length,evidencePriority=EVIDENCE_STATUSES[d.evidence?.status]?.priority||99;return {...d,matchedTerms:matched,score:(exactTitle?30:0)+(allTerms?12:0)+(titleMatches*5)+(matched.length*2)+Math.max(0,7-evidencePriority)}})
    .filter(d=>d.score>0).sort((a,b)=>b.score-a.score||(EVIDENCE_STATUSES[a.evidence?.status]?.priority||99)-(EVIDENCE_STATUSES[b.evidence?.status]?.priority||99)||String(a.title).localeCompare(String(b.title)))
    .filter(d=>{const key=[d.type,d.title,d.raw?.page||d.raw?.pageNumber||"",d.raw?.id||d.raw?.chapterId||""].join("|").toLowerCase();if(seen.has(key))return false;seen.add(key);return true}).slice(0,30);
}
function highlightMatches(value,terms=[]){const source=String(value||""),matches=[];terms.forEach(term=>{let from=0,index;const lower=source.toLowerCase();while((index=lower.indexOf(term,from))!==-1){matches.push([index,index+term.length]);from=index+term.length}});if(!matches.length)return esc(source);matches.sort((a,b)=>a[0]-b[0]);const merged=[];matches.forEach(range=>{const last=merged.at(-1);if(last&&range[0]<=last[1])last[1]=Math.max(last[1],range[1]);else merged.push([...range])});let output="",cursor=0;merged.forEach(([start,end])=>{output+=esc(source.slice(cursor,start))+`<mark>${esc(source.slice(start,end))}</mark>`;cursor=end});return output+esc(source.slice(cursor))}
function searchResultContext(item){if(item.evidence?.source)return item.evidence.source;if(item.raw?.source)return item.raw.source;if(item.raw?.page||item.raw?.pageNumber)return `Official manual page ${item.raw.page||item.raw.pageNumber}`;if(item.raw?.chapterId||item.raw?.chapter)return `Companion chapter ${item.raw.chapterId||item.raw.chapter}`;return item.type}
...
function renderResults(target,items,empty="No matching results."){
  ...
  root.innerHTML=items.map((x,i)=>`<article class="result-card" data-result="${i}" tabindex="0" role="button"><span class="meta">${esc(x.type)} • ${esc(searchResultContext(x))}${x.score?` • relevance ${x.score}`:""}</span><h3>${highlightMatches(x.title,x.matchedTerms)}</h3>${x.evidence?`${evidenceBadge(x.evidence)}<p>${highlightMatches(target==="#assistantResults"?vehicleEvidenceAnswer(x):String(x.evidence.value||"Unknown"),x.matchedTerms)}</p>${x.evidence.source?`<small>Source: ${esc(x.evidence.source)}</small>`:""}`:`<p>${highlightMatches(String(x.text||"").slice(0,280),x.matchedTerms)}</p>`}<span class="open-hint">Tap to open</span></article>`).join("");
...
function reasoningRuntimeRecords(){const make=(id,sourceType,title,value,route)=>({id,sourceType,sourceId:id,title,summary:`${value.archived||value.archiveState?.archived?"Historical archived":"Current owner"} record: ${title}. Status: ${value.status||"recorded"}${value.occurredAt?` at ${value.occurredAt}`:""}.`,text:JSON.stringify(value),keywords:value.tags||[],systems:value.systemId?[value.systemId]:value.systemIds||[],componentIds:value.componentIds||[],manualPages:value.manualPageRefs||[],chapterIds:value.chapterRefs||[],kbIds:value.kbRefs||[],evidenceRefs:value.evidenceRefs||[],confidence:value.confidence||"high",safetyClass:value.safetyClass||value.metadata?.safetyClass||"informational",route,sectionAnchor:"",sourceFile:"saved-state",archived:Boolean(value.archived||value.archiveState?.archived),occurredAt:value.occurredAt||value.documentDate||value.createdAt,searchableText:`${title} ${JSON.stringify(value)}`.toLowerCase(),checksum:"runtime"});return[...(state.faults||[]).map((x,i)=>make(`runtime:fault:${x.id||i}`,"fault-record",x.title||"Fault record",x,"#diagnostics")),...(state.electricalMeasurements||[]).map((x,i)=>make(`runtime:measurement:${x.id||i}`,"measurement",`${x.testPoint||"Electrical"} measurement`,x,"#electrical")),...(state.logs||[]).map((x,i)=>make(`runtime:maintenance:${x.id||i}`,"owner-record",x.title||"Service record",x,"#maintenance")),...(state.maintenancePlans||[]).map((x,i)=>make(`runtime:maintenance-plan:${x.id||i}`,"maintenance-plan",x.title||"Maintenance plan",x,"#maintenance-intelligence")),...(state.ownerRecords||[]).map((x,i)=>make(`runtime:owner:${x.id||i}`,`owner-${x.type}`,x.title||"Owner record",x,"#records")),...(state.evidenceLibrary||[]).map((x,i)=>make(`runtime:evidence:${x.id||i}`,"owner-evidence",x.title||"Evidence metadata",{...x,description:`${x.description||""} Evidence metadata only; file content has not been interpreted.`},"#evidence"))]}
...
function renderCanon(){
  ...
  const tagSelect=$("#canonTag"),selectedTag=tagSelect?.value||"",tags=[...new Set(api.filter().flatMap(record=>record.tags||[]))].sort();if(tagSelect)tagSelect.innerHTML=`<option value="">All tags</option>${tags.map(tag=>`<option${tag===selectedTag?' selected':''}>${esc(tag)}</option>`).join("")}`;
  const query=$("#canonSearch")?.value||"",options={edition:$("#canonEdition")?.value||"",status:$("#canonStatusFilter")?.value||"",tag:selectedTag,sort:$("#canonSort")?.value||"edition"},records=query?api.search(query,options):api.filter(options);
  $("#canonResults").innerHTML=records.length?records.map(record=>`<button class="panel corpus-card" data-canon-id="${esc(record.id)}"><span class="meta">${esc(record.id)} • ${esc(record.edition.replace("-"," "))} • revision ${esc(record.revision)} • ${esc(record.status)}</span><strong>${esc(record.title)}</strong><span>${esc(record.summary||record.purpose||"")}</span><small>${(record.tags||[]).map(tag=>esc(tag)).join(" • ")||"No tags"} • ${record.relatedChapterCount} chapters • ${record.relatedManualPageCount} manual pages</small></button>`).join(""):'<article class="panel corpus-empty"><h2>No Engineering Canon records available</h2><p>The Engineering Corpus infrastructure is ready. Canonical Engineering Canon source documents have not yet been imported.</p></article>';
}
...
function renderDigitalTwin(){
  ...
  digitalTwinRuntimeView=window.KnausDigitalTwinAdapter.buildRuntimeView(api.getTwin(),state);const twin=digitalTwinRuntimeView,stats=api.getStatistics(),report=window.KnausDigitalTwinAdapter.getMappingReport();window.KnausDigitalTwinOwnerOverlay?.build(api.getTwin(),state.ownerRecords||[],state.evidenceLinks||[]);
  ...
  const components=twin.components.filter(component=>!selectedComponent||component.systemId===selectedComponent);$("#twinComponents").innerHTML=components.map(component=>{const related=api.getRelatedEntities(component.id),owner=window.KnausDigitalTwinOwnerOverlay?.getComponentState(component.id)||{};return`<article class="panel twin-card" data-twin-anchor="${esc(component.id)}"><small>${esc(component.id)}</small><strong>${esc(component.name)}</strong><span>${esc(twinEntityName(component.systemId))} • reference: ${esc(component.status)}</span><span class="twin-confidence">${esc(component.runtimeEvidence?.confidence||component.confidence)} • ${(component.evidenceRefs||[]).length} reference evidence</span><p>${related.length} related entities</p><div class="twin-owner-overlay"><strong>Owner-provided history</strong><small>${owner.recordCount||0} records • ${owner.openFaults||0} open faults • ${owner.completedModifications||0} completed modifications</small>${owner.latestMeasurement?`<span>Latest measurement: ${esc(owner.latestMeasurement.title)}</span>`:""}<button class="secondary-btn" data-route="records">Open component records</button></div>${component.route?`<button class="secondary-btn" data-route="${esc(component.route.slice(1))}">Open related area</button>`:""}</article>`}).join("")||'<article class="panel"><p>No components match this system.</p></article>';
...
function payloadMetrics(){
  ...
  const packing=list?packingListMetrics(list).total:0,mam=payloadNumber(plan.mam)||(payloadNumber(evidenceValue(state.vehicleConfiguration?.mam))||Number(state.vehicleProfile?.maxMass)||0);
...
function openDetail(item){
  ...
  if(item.type==="system graph"||item.graphEntityId){navigate("systems");const id=item.raw?.sourceId||item.graphEntityId;setTimeout(()=>window.KnausSystemExplorer?.focus(id),0);return}
...
function electricalReportHtml(){const report=electricalEvidenceData(),vehicle=state.vehicleProfile||{},confirmed=report.components.filter(item=>["plate-confirmed","owner-confirmed","photograph-confirmed"].includes(item.evidence.status)).length,needsConfirmation=report.components.length-confirmed;return `<div class="report-meta"><span>${esc([vehicle.year,vehicle.make,vehicle.model].filter(Boolean).join(" ")||"Vehicle identity not recorded")}</span>${vehicle.registration?`<span>${esc(vehicle.registration)}</span>`:""}<span>Generated ${esc(new Date(report.generatedAt).toLocaleString())}</span></div><section><h2>Evidence overview</h2><dl><div><dt>Electrical components</dt><dd>${report.components.length}</dd></div><div><dt>Confirmed fitted evidence</dt><dd>${confirmed}</dd></div><div><dt>Needs confirmation</dt><dd>${needsConfirmation}</dd></div><div><dt>Recorded measurements</dt><dd>${report.measurements.length}</dd></div></dl></section><section><h2>Component evidence</h2><table><thead><tr><th>Component</th><th>Location / voltage</th><th>Evidence</th><th>Source and notes</th></tr></thead><tbody>${report.components.map(item=>`<tr><td><strong>${esc(item.name)}</strong><br><small>${esc(item.category||"")}</small></td><td>${esc(item.location||"Confirm on vehicle")}<br><small>${esc(item.voltage||"")}</small></td><td>${esc(EVIDENCE_STATUSES[item.evidence.status]?.label||"Unknown")}</td><td>${esc(item.evidence.source||"—")}${item.evidence.lastVerified?`<br><small>Verified ${esc(formatTripDate(item.evidence.lastVerified))}</small>`:""}${item.evidence.notes?`<br><small>${esc(item.evidence.notes)}</small>`:""}</td></tr>`).join("")}</tbody></table></section><section><h2>Documented connections</h2>${report.connections.length?`<table><thead><tr><th>From</th><th>To</th><th>Connection</th></tr></thead><tbody>${report.connections.map(link=>{const from=DATA.electrical.find(item=>item.id===link.from),to=DATA.electrical.find(item=>item.id===link.to);return `<tr><td>${esc(from?.name||link.from)}</td><td>${esc(to?.name||link.to)}</td><td>${esc(link.label||link.type||"—")}</td></tr>`}).join("")}</tbody></table>`:"<p>No electrical connections documented.</p>"}</section><section><h2>Measurement evidence</h2>${report.measurements.length?`<table><thead><tr><th>Date</th><th>Component / test point</th><th>Reading</th><th>Conditions and notes</th></tr></thead><tbody>${report.measurements.map(item=>{const component=DATA.electrical.find(entry=>entry.id===item.componentId);return `<tr><td>${esc(formatTripDate(item.date))}</td><td>${esc(component?.name||"Electrical component")}<br><small>${esc(item.testPoint)}</small></td><td><strong>${esc(item.value)} ${esc(item.unit)}</strong></td><td>${esc(item.conditions||"—")}${item.notes?`<br><small>${esc(item.notes)}</small>`:""}</td></tr>`}).join("")}</tbody></table>`:"<p>No electrical measurements recorded.</p>"}</section>`}
function printElectricalReport(){const popup=window.open("","_blank","width=1100,height=760");if(!popup){toast("Allow pop-ups to print this report");return}popup.document.write(`<!doctype html><html><head><title>Knaus electrical system report</title><style>body{font:14px system-ui;max-width:1100px;margin:28px auto;padding:0 20px;color:#172033}h1{margin-bottom:4px}.subtitle{color:#526071}.report-meta{display:flex;gap:8px;flex-wrap:wrap}.report-meta span,dl div{padding:8px;background:#eef2f6;border-radius:8px}section{margin:24px 0;break-inside:auto}dl{display:grid;grid-template-columns:repeat(4,1fr);gap:8px}dt{color:#526071}dd{margin:3px 0 0;font-weight:700}table{width:100%;border-collapse:collapse;font-size:12px}th,td{text-align:left;padding:7px;border:1px solid #ccd3dc;vertical-align:top}th{background:#eef2f6}tr{break-inside:avoid}small{color:#526071}@media(max-width:700px){dl{grid-template-columns:1fr 1fr}}@media print{body{margin:0;padding:0}}</style></head><body><h1>Electrical system report</h1><p class="subtitle">Knaus Companion fitted-equipment and measurement evidence handoff</p>${electricalReportHtml()}</body></html>`);popup.document.close();popup.focus();setTimeout(()=>popup.print(),200)}
function saveElectricalMeasurement(event){event.preventDefault();const values=Object.fromEntries(new FormData(event.currentTarget)),measurement={id:`electrical-measurement-${Date.now()}`,date:values.date,componentId:values.componentId,testPoint:values.testPoint.trim(),value:values.value.trim(),unit:values.unit,conditions:values.conditions.trim(),notes:values.notes.trim(),createdAt:new Date().toISOString()};state.electricalMeasurements=[measurement,...(state.electricalMeasurements||[])];saveState();event.currentTarget.reset();$("#electricalMeasurementDate").value=new Date().toISOString().slice(0,10);$("#electricalMeasurementComponent").value=activeElectricalComponent;renderElectrical();toast("Electrical measurement recorded")}
function deleteElectricalMeasurement(id){const measurement=(state.electricalMeasurements||[]).find(item=>item.id===id);if(!measurement||!confirm(`Delete ${measurement.testPoint} measurement from ${formatTripDate(measurement.date)}?`))return;state.electricalMeasurements=state.electricalMeasurements.filter(item=>item.id!==id);saveState();renderElectrical();toast("Electrical measurement deleted")}
function electricalMeasurementKind(item){if(item.unit==="V")return"voltage";if(["A","mA"].includes(item.unit))return"current";if(item.unit==="°C")return"temperature";return"other"}
function filteredElectricalMeasurements(){const measurements=[...(state.electricalMeasurements||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)));return electricalMeasurementFilter==="all"?measurements:measurements.filter(item=>electricalMeasurementKind(item)===electricalMeasurementFilter)}
function exportElectricalMeasurementsCsv(){const measurements=filteredElectricalMeasurements();if(!measurements.length){toast("No electrical measurements to export");return}const quote=value=>`"${String(value??"").replace(/"/g,'""')}"`,rows=measurements.map(item=>{const component=DATA.electrical.find(entry=>entry.id===item.componentId);return[item.date,component?.name||"Electrical component",item.testPoint,item.value,item.unit,item.conditions||"",item.notes||""]}),csv=[["Date","Component","Test point","Value","Unit","Conditions","Notes"],...rows].map(row=>row.map(quote).join(",")).join("\r\n"),blob=new Blob(["\ufeff",csv],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`knaus-electrical-measurements-${electricalMeasurementFilter}-${new Date().toISOString().slice(0,10)}.csv`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast(`${measurements.length} electrical measurements exported`)}
function renderElectricalMeasurementInsights(){const measurements=[...(state.electricalMeasurements||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt))),visible=filteredElectricalMeasurements(),today=new Date(`${new Date().toISOString().slice(0,10)}T00:00:00Z`),recent=measurements.filter(item=>{const date=new Date(`${item.date}T00:00:00Z`),age=(today-date)/86400000;return Number.isFinite(date.getTime())&&age>=0&&age<=30}).length,components=new Set(measurements.map(item=>item.componentId)).size,counts={voltage:measurements.filter(item=>electricalMeasurementKind(item)==="voltage").length,current:measurements.filter(item=>electricalMeasurementKind(item)==="current").length,temperature:measurements.filter(item=>electricalMeasurementKind(item)==="temperature").length,other:measurements.filter(item=>electricalMeasurementKind(item)==="other").length},filters=[["all","All",measurements.length],["voltage","Voltage",counts.voltage],["current","Current",counts.current],["temperature","Temperature",counts.temperature],["other","Other",counts.other]];$("#electricalMeasurementInsights").innerHTML=[[measurements.length,"Readings"],[components,"Components measured"],[recent,"Last 30 days"],[measurements.length?formatTripDate(measurements[0].date):"—","Latest reading"]].map(([value,label])=>`<article class="stat-card"><strong>${esc(value)}</strong><span>${label}</span></article>`).join("");$("#electricalMeasurementFilters").innerHTML=filters.map(([id,label,count])=>`<button class="chip ${electricalMeasurementFilter===id?"active":""}" data-electrical-measurement-filter="${id}" aria-pressed="${electricalMeasurementFilter===id}">${label} <span>${count}</span></button>`).join("");$("#electricalMeasurementResultCount").textContent=measurements.length?`Showing ${visible.length} of ${measurements.length} readings`:"No electrical readings";$("#electricalMeasurementHistory").innerHTML=visible.length?visible.map(item=>{const component=DATA.electrical.find(entry=>entry.id===item.componentId);return `<article class="panel electrical-measurement-card"><div><small>${esc(formatTripDate(item.date))} • ${esc(component?.name||"Electrical component")}</small><strong>${esc(item.value)} ${esc(item.unit)}</strong><span>${esc(item.testPoint)}</span>${item.conditions?`<p>${esc(item.conditions)}</p>`:""}${item.notes?`<small>${esc(item.notes)}</small>`:""}</div><button class="danger-btn" data-electrical-measurement-delete="${esc(item.id)}">Delete</button></article>`}).join(""):`<article class="panel electrical-measurement-empty"><strong>${measurements.length?"No readings match this filter":"No electrical measurements recorded yet"}</strong><p>${measurements.length?"Choose another measurement type to review the recorded evidence.":"Record a reading above to begin the offline evidence history."}</p></article>`}
function renderElectricalInspector(){
  ...
  const readings=component.normalReadings||[component.expected].filter(Boolean),evidence=electricalComponentEvidence(component),measurements=[...(state.electricalMeasurements||[])].filter(item=>item.componentId===component.id).sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)));
  $("#electricalInspector").innerHTML=`
    ...
    <section class="detail-section"><h3>Recorded measurements</h3>${measurements.length?`<div class="electrical-measurement-list">${measurements.map(item=>`<article><div><strong>${esc(item.value)} ${esc(item.unit)}</strong><small>${esc(formatTripDate(item.date))} • ${esc(item.testPoint)}</small>${item.conditions?`<small>${esc(item.conditions)}</small>`:""}${item.notes?`<p>${esc(item.notes)}</p>`:""}</div><button class="danger-btn" data-electrical-measurement-delete="${esc(item.id)}">Delete</button></article>`).join("")}</div>`:"<p>No measurements recorded for this component.</p>"}</section>
...
function renderElectrical(){
  ...
  const measurementSelect=$("#electricalMeasurementComponent");measurementSelect.innerHTML=DATA.electrical.map(component=>`<option value="${esc(component.id)}">${esc(component.name)}</option>`).join("");if(!$("#electricalMeasurementDate").value)$("#electricalMeasurementDate").value=new Date().toISOString().slice(0,10);measurementSelect.value=activeElectricalComponent;
  ...
  renderElectricalMeasurementInsights();
...
function heatingServiceStatus(){const schedule=state.heatingServiceSchedule||{},nextDue=schedule.nextDue||(schedule.lastService&&Number(schedule.intervalMonths)?addMonths(schedule.lastService,Number(schedule.intervalMonths)):"");if(!nextDue)return{status:"baseline",label:"Service baseline not recorded",nextDue:""};const days=Math.ceil((new Date(`${nextDue}T23:59:59`)-new Date())/86400000);if(days<0)return{status:"overdue",label:`Overdue by ${Math.abs(days)} days`,nextDue,days};if(days<=30)return{status:"due",label:days===0?"Due today":`Due in ${days} days`,nextDue,days};return{status:"current",label:`Current for ${days} days`,nextDue,days}}
function renderHeatingServiceSchedule(){const form=$("#heatingServiceForm"),schedule=state.heatingServiceSchedule||{},status=heatingServiceStatus(),history=[...(state.heatingServiceHistory||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)));if(!form.dataset.loaded){$("#heatingServiceLastDate").value=schedule.lastService||"";$("#heatingServiceInterval").value=schedule.intervalMonths||12;$("#heatingServiceProvider").value=schedule.provider||"";$("#heatingServiceReference").value=schedule.reference||"";$("#heatingServiceNotes").value=schedule.notes||"";form.dataset.loaded="true"}$("#heatingServiceStatus").textContent=status.nextDue?`${status.label} • ${formatTripDate(status.nextDue)}`:status.label;$("#heatingServiceStatus").className=`meta heating-service-${status.status}`;$("#heatingServiceHistory").innerHTML=history.length?history.map(item=>`<article class="panel heating-service-record"><div><small>${esc(formatTripDate(item.date))}${item.provider?` • ${esc(item.provider)}`:""}</small><strong>${esc(item.reference||"Heating service completed")}</strong>${item.notes?`<p>${esc(item.notes)}</p>`:""}<span>Next due ${esc(formatTripDate(item.nextDue))}</span></div><button class="danger-btn" data-heating-service-delete="${item.id}">Delete</button></article>`).join(""):'<article class="panel heating-service-empty"><strong>No completed heating services recorded</strong><p>Use “Record completed service” to create durable service evidence.</p></article>'}
function saveHeatingServiceSchedule(event){event.preventDefault();const values=Object.fromEntries(new FormData(event.currentTarget)),intervalMonths=Number(values.intervalMonths)||12;state.heatingServiceSchedule={lastService:values.lastService,intervalMonths,provider:values.provider.trim(),reference:values.reference.trim(),notes:values.notes.trim(),nextDue:addMonths(values.lastService,intervalMonths),updatedAt:new Date().toISOString()};saveState();delete event.currentTarget.dataset.loaded;renderHeatingServiceSchedule();renderHome();toast("Heating service schedule saved")}
function recordHeatingService(){const form=$("#heatingServiceForm");if(!form.reportValidity())return;const values=Object.fromEntries(new FormData(form)),intervalMonths=Number(values.intervalMonths)||12,nextDue=addMonths(values.lastService,intervalMonths),record={id:`heating-service-${Date.now()}`,date:values.lastService,intervalMonths,provider:values.provider.trim(),reference:values.reference.trim(),notes:values.notes.trim(),nextDue,createdAt:new Date().toISOString()};state.heatingServiceHistory=[record,...(state.heatingServiceHistory||[])];state.heatingServiceSchedule={lastService:record.date,intervalMonths,provider:record.provider,reference:record.reference,notes:record.notes,nextDue,updatedAt:record.createdAt};saveState();delete form.dataset.loaded;renderHeatingServiceSchedule();renderHome();toast("Heating service completion recorded")}
function deleteHeatingServiceRecord(id){const item=(state.heatingServiceHistory||[]).find(entry=>entry.id===id);if(!item||!confirm(`Delete heating service from ${formatTripDate(item.date)}?`))return;state.heatingServiceHistory=state.heatingServiceHistory.filter(entry=>entry.id!==id);saveState();renderHeatingServiceSchedule();toast("Heating service record deleted")}
function exportHeatingServiceCalendar(){const schedule=state.heatingServiceSchedule||{},status=heatingServiceStatus();if(!status.nextDue){toast("Save a heating service schedule before exporting a reminder");return}const escapeIcs=value=>String(value||"").replace(/\\/g,"\\\\").replace(/\n/g,"\\n").replace(/,/g,"\\,").replace(/;/g,"\\;"),stamp=new Date().toISOString().replace(/[-:]/g,"").replace(/\.\d{3}/,""),description=[schedule.provider&&`Provider: ${schedule.provider}`,schedule.reference&&`Reference: ${schedule.reference}`,schedule.notes].filter(Boolean).join(" • "),lines=["BEGIN:VCALENDAR","VERSION:2.0","PRODID:-//Knaus Companion//Heating Service//EN","CALSCALE:GREGORIAN","BEGIN:VEVENT",`UID:heating-service-${status.nextDue}@knaus-companion`,`DTSTAMP:${stamp}`,`DTSTART;VALUE=DATE:${status.nextDue.replace(/-/g,"")}`,"SUMMARY:Heating service due",`DESCRIPTION:${escapeIcs(description||"Heating service due according to the saved Knaus Companion schedule.")}`,"BEGIN:VALARM","TRIGGER:-P30D","ACTION:DISPLAY","DESCRIPTION:Heating service due in 30 days","END:VALARM","END:VEVENT","END:VCALENDAR"],blob=new Blob([lines.join("\r\n")],{type:"text/calendar;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`knaus-heating-service-${status.nextDue}.ics`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast(`Heating service reminder exported for ${formatTripDate(status.nextDue)}`)}
function renderHeatingRuns(){const runs=[...(state.heatingRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt))),visible=heatingRunFilter==="all"?runs:runs.filter(item=>item.result===heatingRunFilter),counts={normal:runs.filter(item=>item.result==="normal").length,monitor:runs.filter(item=>item.result==="monitor").length,action:runs.filter(item=>item.result==="action").length},runtime=runs.reduce((sum,item)=>sum+(Number(item.duration)||0),0),filters=[["all","All",runs.length],["normal","Normal",counts.normal],["monitor","Monitor",counts.monitor],["action","Action required",counts.action]];if(!$("#heatingRunDate").value)$("#heatingRunDate").value=new Date().toISOString().slice(0,10);$("#heatingRunSummary").textContent=runs.length?`${runs.length} tests • ${counts.action} action required`:"No tests recorded";$("#heatingRunInsights").innerHTML=[[runs.length,"Test runs"],[counts.monitor+counts.action,"Issues observed"],[runtime,"Minutes tested"]].map(([value,label])=>`<article class="stat-card"><strong>${value}</strong><span>${label}</span></article>`).join("");$("#heatingRunFilters").innerHTML=filters.map(([id,label,count])=>`<button class="chip ${heatingRunFilter===id?"active":""}" data-heating-run-filter="${id}" aria-pressed="${heatingRunFilter===id}">${label} <span>${count}</span></button>`).join("");$("#heatingRunResultCount").textContent=runs.length?`Showing ${visible.length} of ${runs.length} test runs`:"No test runs";$("#heatingRunHistory").innerHTML=visible.length?visible.map(item=>`<article class="panel heating-run-card result-${item.result}"><span>${item.result==="normal"?"✓":item.result==="monitor"?"!":"⚠"}</span><div><small>${esc(formatTripDate(item.date))} • ${esc(item.mode)} • ${Number(item.duration)} min</small><strong>${item.result==="action"?"Action required":item.result==="monitor"?"Monitor":"Normal operation"}</strong>${item.faultCode?`<p><b>Fault:</b> ${esc(item.faultCode)}</p>`:""}${item.notes?`<p>${esc(item.notes)}</p>`:""}</div><button class="danger-btn" data-heating-run-delete="${item.id}">Delete</button></article>`).join(""):`<article class="panel heating-run-empty"><strong>${runs.length?"No tests match this filter":"No heating test runs recorded yet"}</strong><p>${runs.length?"Choose another result filter to review the recorded evidence.":"Record a space-heating, hot-water or combined test above."}</p></article>`}
function saveHeatingRun(event){event.preventDefault();const values=Object.fromEntries(new FormData(event.currentTarget)),run={id:`heating-run-${Date.now()}`,date:values.date,mode:values.mode,duration:Number(values.duration),result:values.result,faultCode:values.faultCode.trim(),notes:values.notes.trim(),createdAt:new Date().toISOString()};state.heatingRuns=[run,...(state.heatingRuns||[])];saveState();event.currentTarget.reset();$("#heatingRunDate").value=new Date().toISOString().slice(0,10);renderHeatingRuns();renderHome();toast("Heating test run recorded")}
function deleteHeatingRun(id){const run=(state.heatingRuns||[]).find(item=>item.id===id);if(!run||!confirm(`Delete heating test from ${formatTripDate(run.date)}?`))return;state.heatingRuns=state.heatingRuns.filter(item=>item.id!==id);saveState();renderHeatingRuns();renderHome();toast("Heating test run deleted")}
function filteredHeatingRuns(){const runs=[...(state.heatingRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)));return heatingRunFilter==="all"?runs:runs.filter(item=>item.result===heatingRunFilter)}
function exportHeatingRunsCsv(){const runs=filteredHeatingRuns();if(!runs.length){toast("No heating test runs to export");return}const quote=value=>`"${String(value??"").replace(/"/g,'""')}"`,rows=runs.map(item=>[item.date,item.mode,Number(item.duration)||0,item.result,item.faultCode||"",item.notes||""]),csv=[["Date","Mode","Duration minutes","Result","Fault code","Observations"],...rows].map(row=>row.map(quote).join(",")).join("\r\n"),blob=new Blob([csv],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`knaus-heating-tests-${heatingRunFilter}-${new Date().toISOString().slice(0,10)}.csv`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast(`${runs.length} heating test runs exported`)}
function heatingEvidenceData(){const readiness=HEATING_READINESS_ITEMS.map(item=>({...item,complete:Boolean(state.heatingReadiness?.[item.id])})),complete=readiness.filter(item=>item.complete).length;return{app:"Knaus Companion",version:APP_VERSION,generatedAt:new Date().toISOString(),heatingProfile:state.heatingProfile||{},vehicleConfigurationEvidence:{heating:normaliseEvidence(state.vehicleConfiguration?.heating)},serviceSchedule:{...(state.heatingServiceSchedule||{}),status:heatingServiceStatus()},serviceHistory:[...(state.heatingServiceHistory||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))),readiness:{score:Math.round(complete/readiness.length*100),complete,total:readiness.length,items:readiness},testRuns:[...(state.heatingRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)))}}
function exportHeatingEvidence(){const report=heatingEvidenceData(),blob=new Blob([JSON.stringify(report,null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`knaus-heating-evidence-${report.generatedAt.slice(0,10)}.json`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast("Heating evidence pack exported")}
function heatingReportHtml(){const report=heatingEvidenceData(),profile=report.heatingProfile,runs=report.testRuns,registry=report.vehicleConfigurationEvidence.heating;return `<div class="report-meta"><span>Version ${esc(report.version)}</span><span>Generated ${esc(new Date(report.generatedAt).toLocaleString())}</span><span>${runs.length} test runs</span></div><section><h2>Fitted heating configuration</h2><p><strong>Vehicle registry evidence:</strong> ${esc(EVIDENCE_STATUSES[registry.status].label)}${registry.source?` — ${esc(registry.source)}`:""}</p><dl><div><dt>Appliance / model</dt><dd>${esc(profile.appliance||"Not confirmed")}</dd></div><div><dt>Energy</dt><dd>${esc(profile.energy||"Not confirmed")}</dd></div><div><dt>Controller</dt><dd>${esc(profile.controller||"Not confirmed")}</dd></div><div><dt>Location</dt><dd>${esc(profile.location||"Not confirmed")}</dd></div></dl>${profile.notes?`<p><strong>Configuration notes:</strong> ${esc(profile.notes)}</p>`:""}</section><section><h2>Pre-start readiness — ${report.readiness.score}%</h2><ul>${report.readiness.items.map(item=>`<li>${item.complete?"✓":"○"} ${esc(item.title)} — ${esc(item.detail)}</li>`).join("")}</ul></section><section><h2>Operational test history</h2>${runs.length?`<table><thead><tr><th>Date</th><th>Mode</th><th>Duration</th><th>Result</th><th>Fault / observations</th></tr></thead><tbody>${runs.map(item=>`<tr><td>${esc(formatTripDate(item.date))}</td><td>${esc(item.mode)}</td><td>${Number(item.duration)||0} min</td><td>${esc(item.result==="action"?"Action required":item.result==="monitor"?"Monitor":"Normal")}</td><td>${esc([item.faultCode,item.notes].filter(Boolean).join(" • ")||"—")}</td></tr>`).join("")}</tbody></table>`:"<p>No heating test runs recorded.</p>"}</section>`}
function printHeatingReport(){const popup=window.open("","_blank","width=1000,height=760");if(!popup){toast("Allow pop-ups to print this report");return}popup.document.write(`<!doctype html><html><head><title>Knaus heating report</title><style>body{font:14px system-ui;max-width:1000px;margin:28px auto;padding:0 20px;color:#172033}h1{margin-bottom:4px}.subtitle{color:#526071}.report-meta{display:flex;gap:8px;flex-wrap:wrap}.report-meta span,dl div{padding:8px;background:#eef2f6;border-radius:8px}section{margin:24px 0}dl{display:grid;grid-template-columns:1fr 1fr;gap:8px}dt{color:#526071}dd{margin:3px 0 0;font-weight:700}ul{padding-left:22px}li{margin:7px 0}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:8px;border:1px solid #ccd3dc;vertical-align:top}th{background:#eef2f6}@media print{body{margin:0}}</style></head><body><h1>Heating system report</h1><p class="subtitle">Knaus Companion operational evidence handoff</p>${heatingReportHtml()}</body></html>`);popup.document.close();popup.focus();setTimeout(()=>popup.print(),200)}
function renderHeatingInspector(){
  ...
  const profile=state.heatingProfile||{};if(profile.appliance||profile.energy||profile.controller||profile.location)$("#heatingInspector").insertAdjacentHTML("afterbegin",`<section class="heating-confirmed-context"><span class="meta">Owner-confirmed configuration</span><strong>${esc(profile.appliance||"Heating appliance")}</strong><small>${esc([profile.energy,profile.controller,profile.location].filter(Boolean).join(" • "))}</small></section>`);
}
function renderHeating(){
  renderHeatingProfile();
  renderHeatingReadiness();
  renderHeatingServiceSchedule();
  renderHeatingRuns();
...
function refrigerationComponents(){return refrigerationFilter==="all"?REFRIGERATION_COMPONENTS:REFRIGERATION_COMPONENTS.filter(item=>item.view===refrigerationFilter)}
function renderRefrigerationProfile(){const form=$("#refrigerationProfileForm"),profile=state.refrigerationProfile||{};if(!form.dataset.loaded){$("#refrigerationProfileModel").value=profile.model||"";$("#refrigerationProfileTechnology").value=profile.technology||"";$("#refrigerationProfileEnergy").value=profile.energyModes||"";$("#refrigerationProfileLocation").value=profile.location||"";$("#refrigerationProfileNotes").value=profile.notes||"";form.dataset.loaded="true"}const confirmed=[profile.model,profile.technology,profile.energyModes,profile.location].filter(Boolean).length;$("#refrigerationProfileStatus").textContent=confirmed===4?"Configuration confirmed":confirmed?`${confirmed}/4 details confirmed`:"Not confirmed"}
function saveRefrigerationProfile(event){event.preventDefault();const values=Object.fromEntries(new FormData(event.currentTarget));state.refrigerationProfile={model:values.model.trim(),technology:values.technology,energyModes:values.energyModes.trim(),location:values.location.trim(),notes:values.notes.trim(),updatedAt:new Date().toISOString()};saveState();delete event.currentTarget.dataset.loaded;renderRefrigeration();toast("Refrigeration configuration saved")}
function renderRefrigerationReadiness(){const readiness=state.refrigerationReadiness||{},done=REFRIGERATION_READINESS_ITEMS.filter(item=>readiness[item.id]).length,score=Math.round(done/REFRIGERATION_READINESS_ITEMS.length*100);$("#refrigerationReadinessScore").textContent=`${score}%`;$("#refrigerationReadinessBar").style.width=`${score}%`;$("#refrigerationReadinessChecklist").innerHTML=REFRIGERATION_READINESS_ITEMS.map(item=>{const complete=Boolean(readiness[item.id]);return `<article class="heating-readiness-item ${complete?"complete":""}"><button data-refrigeration-readiness="${item.id}" role="checkbox" aria-checked="${complete}"><span>${complete?"✓":""}</span><span><strong>${esc(item.title)}</strong><small>${esc(item.detail)}</small></span></button><button class="secondary-btn" data-route="${item.route}">Guidance</button></article>`}).join("")}
function toggleRefrigerationReadiness(id){state.refrigerationReadiness={...(state.refrigerationReadiness||{}),[id]:!state.refrigerationReadiness?.[id],updatedAt:new Date().toISOString()};saveState();renderRefrigerationReadiness();toast(state.refrigerationReadiness[id]?"Refrigeration readiness check complete":"Refrigeration readiness check reopened")}
function renderRefrigerationRuns(){const runs=[...(state.refrigerationRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt))),visible=refrigerationRunFilter==="all"?runs:runs.filter(item=>item.result===refrigerationRunFilter),counts={normal:runs.filter(item=>item.result==="normal").length,monitor:runs.filter(item=>item.result==="monitor").length,action:runs.filter(item=>item.result==="action").length},averageDrop=runs.length?runs.reduce((sum,item)=>sum+(Number(item.startTemperature)-Number(item.endTemperature)),0)/runs.length:0,filters=[["all","All",runs.length],["normal","Normal",counts.normal],["monitor","Monitor",counts.monitor],["action","Action required",counts.action]];if(!$("#refrigerationRunDate").value)$("#refrigerationRunDate").value=new Date().toISOString().slice(0,10);$("#refrigerationRunSummary").textContent=runs.length?`${runs.length} tests • ${counts.action} action required`:"No tests recorded";$("#refrigerationRunInsights").innerHTML=[[runs.length,"Cooling tests"],[counts.monitor+counts.action,"Issues observed"],[`${averageDrop.toFixed(1)}°C`,"Average temperature drop"]].map(([value,label])=>`<article class="stat-card"><strong>${value}</strong><span>${label}</span></article>`).join("");$("#refrigerationRunFilters").innerHTML=filters.map(([id,label,count])=>`<button class="chip ${refrigerationRunFilter===id?"active":""}" data-refrigeration-run-filter="${id}" aria-pressed="${refrigerationRunFilter===id}">${label} <span>${count}</span></button>`).join("");$("#refrigerationRunResultCount").textContent=runs.length?`Showing ${visible.length} of ${runs.length} cooling tests`:"No cooling tests";$("#refrigerationRunHistory").innerHTML=visible.length?visible.map(item=>`<article class="panel heating-run-card result-${item.result}"><span>${item.result==="normal"?"✓":item.result==="monitor"?"!":"⚠"}</span><div><small>${esc(formatTripDate(item.date))} • ${esc(item.energyMode)} • ${Number(item.duration)} min</small><strong>${item.result==="action"?"Action required":item.result==="monitor"?"Monitor":"Normal cooling"}</strong><p><b>Temperature:</b> ${Number(item.startTemperature)}°C → ${Number(item.endTemperature)}°C</p>${item.notes?`<p>${esc(item.notes)}</p>`:""}</div><button class="danger-btn" data-refrigeration-run-delete="${item.id}">Delete</button></article>`).join(""):`<article class="panel heating-run-empty"><strong>${runs.length?"No cooling tests match this filter":"No refrigeration cooling tests recorded yet"}</strong><p>${runs.length?"Choose another result filter to review the recorded evidence.":"Record a cooling test above to begin the offline history."}</p></article>`}
function saveRefrigerationRun(event){event.preventDefault();const values=Object.fromEntries(new FormData(event.currentTarget)),run={id:`refrigeration-run-${Date.now()}`,date:values.date,energyMode:values.energyMode,duration:Number(values.duration),startTemperature:Number(values.startTemperature),endTemperature:Number(values.endTemperature),result:values.result,notes:values.notes.trim(),createdAt:new Date().toISOString()};state.refrigerationRuns=[run,...(state.refrigerationRuns||[])];saveState();event.currentTarget.reset();$("#refrigerationRunDate").value=new Date().toISOString().slice(0,10);renderRefrigerationRuns();renderHome();toast("Refrigeration cooling test recorded")}
function deleteRefrigerationRun(id){const run=(state.refrigerationRuns||[]).find(item=>item.id===id);if(!run||!confirm(`Delete refrigeration test from ${formatTripDate(run.date)}?`))return;state.refrigerationRuns=state.refrigerationRuns.filter(item=>item.id!==id);saveState();renderRefrigerationRuns();renderHome();toast("Refrigeration cooling test deleted")}
function filteredRefrigerationRuns(){const runs=[...(state.refrigerationRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)));return refrigerationRunFilter==="all"?runs:runs.filter(item=>item.result===refrigerationRunFilter)}
function exportRefrigerationRunsCsv(){const runs=filteredRefrigerationRuns();if(!runs.length){toast("No refrigeration cooling tests to export");return}const quote=value=>`"${String(value??"").replace(/"/g,'""')}"`,rows=runs.map(item=>[item.date,item.energyMode,Number(item.duration)||0,Number(item.startTemperature),Number(item.endTemperature),Number(item.startTemperature)-Number(item.endTemperature),item.result,item.notes||""]),csv=[["Date","Energy mode","Duration minutes","Start temperature C","End temperature C","Temperature drop C","Result","Observations"],...rows].map(row=>row.map(quote).join(",")).join("\r\n"),blob=new Blob([csv],{type:"text/csv;charset=utf-8"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`knaus-refrigeration-tests-${refrigerationRunFilter}-${new Date().toISOString().slice(0,10)}.csv`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast(`${runs.length} refrigeration cooling tests exported`)}
function refrigerationEvidenceData(){const readiness=REFRIGERATION_READINESS_ITEMS.map(item=>({...item,complete:Boolean(state.refrigerationReadiness?.[item.id])})),complete=readiness.filter(item=>item.complete).length;return{app:"Knaus Companion",version:APP_VERSION,generatedAt:new Date().toISOString(),refrigerationProfile:state.refrigerationProfile||{},vehicleConfigurationEvidence:{manufacturer:normaliseEvidence(state.vehicleConfiguration?.fridgeManufacturer),type:normaliseEvidence(state.vehicleConfiguration?.fridgeType),model:normaliseEvidence(state.vehicleConfiguration?.fridge)},readiness:{score:Math.round(complete/readiness.length*100),complete,total:readiness.length,items:readiness},coolingTests:[...(state.refrigerationRuns||[])].sort((a,b)=>String(b.date).localeCompare(String(a.date))||String(b.createdAt).localeCompare(String(a.createdAt)))}}
function exportRefrigerationEvidence(){const report=refrigerationEvidenceData(),blob=new Blob([JSON.stringify(report,null,2)],{type:"application/json"}),a=document.createElement("a");a.href=URL.createObjectURL(blob);a.download=`knaus-refrigeration-evidence-${report.generatedAt.slice(0,10)}.json`;a.click();setTimeout(()=>URL.revokeObjectURL(a.href),1000);toast("Refrigeration evidence pack exported")}
function refrigerationReportHtml(){const report=refrigerationEvidenceData(),profile=report.refrigerationProfile,runs=report.coolingTests,registry=report.vehicleConfigurationEvidence;return `<div class="report-meta"><span>Version ${esc(report.version)}</span><span>Generated ${esc(new Date(report.generatedAt).toLocaleString())}</span><span>${runs.length} cooling tests</span></div><section><h2>Fitted refrigeration configuration</h2><p><strong>Vehicle registry evidence:</strong> ${esc([registry.manufacturer,registry.type,registry.model].map(item=>`${item.value||"Unknown"} — ${EVIDENCE_STATUSES[item.status].label}`).join(" • "))}</p><dl><div><dt>Refrigerator / model</dt><dd>${esc(profile.model||"Not confirmed")}</dd></div><div><dt>Technology</dt><dd>${esc(profile.technology||"Not confirmed")}</dd></div><div><dt>Energy modes</dt><dd>${esc(profile.energyModes||"Not confirmed")}</dd></div><div><dt>Location</dt><dd>${esc(profile.location||"Not confirmed")}</dd></div></dl>${profile.notes?`<p><strong>Configuration notes:</strong> ${esc(profile.notes)}</p>`:""}</section><section><h2>Pre-operation readiness — ${report.readiness.score}%</h2><ul>${report.readiness.items.map(item=>`<li>${item.complete?"✓":"○"} ${esc(item.title)} — ${esc(item.detail)}</li>`).join("")}</ul></section><section><h2>Cooling-test history</h2>${runs.length?`<table><thead><tr><th>Date</th><th>Energy</th><th>Duration</th><th>Temperature</th><th>Drop</th><th>Result / observations</th></tr></thead><tbody>${runs.map(item=>{const drop=Number(item.startTemperature)-Number(item.endTemperature);return `<tr><td>${esc(formatTripDate(item.date))}</td><td>${esc(item.energyMode)}</td><td>${Number(item.duration)||0} min</td><td>${Number(item.startTemperature)}°C → ${Number(item.endTemperature)}°C</td><td>${drop.toFixed(1)}°C</td><td>${esc(item.result==="action"?"Action required":item.result==="monitor"?"Monitor":"Normal")}${item.notes?`<br>${esc(item.notes)}`:""}</td></tr>`}).join("")}</tbody></table>`:"<p>No refrigeration cooling tests recorded.</p>"}</section>`}
function printRefrigerationReport(){const popup=window.open("","_blank","width=1100,height=760");if(!popup){toast("Allow pop-ups to print this report");return}popup.document.write(`<!doctype html><html><head><title>Knaus refrigeration report</title><style>body{font:14px system-ui;max-width:1100px;margin:28px auto;padding:0 20px;color:#172033}h1{margin-bottom:4px}.subtitle{color:#526071}.report-meta{display:flex;gap:8px;flex-wrap:wrap}.report-meta span,dl div{padding:8px;background:#eef2f6;border-radius:8px}section{margin:24px 0}dl{display:grid;grid-template-columns:1fr 1fr;gap:8px}dt{color:#526071}dd{margin:3px 0 0;font-weight:700}ul{padding-left:22px}li{margin:7px 0}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:8px;border:1px solid #ccd3dc;vertical-align:top}th{background:#eef2f6}@media print{body{margin:0}}</style></head><body><h1>Refrigeration system report</h1><p class="subtitle">Knaus Companion operational evidence handoff</p>${refrigerationReportHtml()}</body></html>`);popup.document.close();popup.focus();setTimeout(()=>popup.print(),200)}
function renderRefrigerationInspector(){const component=REFRIGERATION_COMPONENTS.find(item=>item.id===activeRefrigerationComponent)||refrigerationComponents()[0];if(!component){$("#refrigerationInspector").innerHTML="<h2>No matching refrigeration components</h2><p>Select another refrigeration view.</p>";return}activeRefrigerationComponent=component.id;const related=REFRIGERATION_RELATIONS.filter(([from,to])=>from===component.id||to===component.id);$("#refrigerationInspector").innerHTML=`<span class="meta">${esc(component.category)}</span><h2>${esc(component.name)}</h2><div class="diagnostic-meta"><span>${esc(component.status)}</span></div><p>${esc(component.purpose)}</p><div class="gas-caution"><strong>Configuration and safety boundary</strong><span>Confirm the fitted refrigerator model and supported energy modes. Gas, combustion, sealed cooling-unit and fixed mains work require a competent technician.</span></div><dl class="component-facts"><div><dt>Location</dt><dd>${esc(component.location)}</dd></div><div><dt>Operation</dt><dd>${esc(component.operation)}</dd></div></dl><section class="detail-section"><h3>User-level checks</h3><ol>${component.checks.map(item=>`<li>${esc(item)}</li>`).join("")}</ol></section>${related.length?`<section class="detail-section"><h3>Connected refrigeration path</h3><ul>${related.map(([from,to,label])=>{const other=REFRIGERATION_COMPONENTS.find(item=>item.id===(from===component.id?to:from));return `<li><strong>${esc(from===component.id?"To":"From")} ${esc(other?.name||"component")}</strong><br>${esc(label)}</li>`}).join("")}</ul></section>`:""}<div class="diagnostic-link-row">${component.routes.map(route=>`<button class="secondary-btn" data-route="${route}">Open ${esc(route)}</button>`).join("")}</div>`;const profile=state.refrigerationProfile||{};if(profile.model||profile.technology||profile.energyModes||profile.location)$("#refrigerationInspector").insertAdjacentHTML("afterbegin",`<section class="heating-confirmed-context"><span class="meta">Owner-confirmed configuration</span><strong>${esc(profile.model||"Refrigerator")}</strong><small>${esc([profile.technology,profile.energyModes,profile.location].filter(Boolean).join(" • "))}</small></section>`)}
function renderRefrigeration(){renderRefrigerationProfile();const filters=[["all","All paths"],["control","Controls"],["energy","Energy"],["cooling","Cooling"],["ventilation","Ventilation"],["safety","Safety"]],components=refrigerationComponents(),visibleIds=new Set(components.map(item=>item.id)),links=REFRIGERATION_RELATIONS.filter(([from,to])=>visibleIds.has(from)&&visibleIds.has(to));$("#refrigerationFilters").innerHTML=filters.map(([id,label])=>`<button class="chip ${refrigerationFilter===id?"active":""}" data-refrigeration-filter="${id}">${label}</button>`).join("");$("#refrigerationSummary").innerHTML=[[components.length,"Components"],[links.length,"Visible connections"],[components.filter(item=>item.status.toLowerCase().includes("confirm")).length,"Items to confirm"]].map(([value,label])=>`<article class="stat-card"><strong>${value}</strong><span>${label}</span></article>`).join("");$("#refrigerationLegend").innerHTML=`<span><i class="legend-dot refrigeration-control"></i>Control</span><span><i class="legend-dot refrigeration-energy"></i>Energy</span><span><i class="legend-dot refrigeration-cooling"></i>Cooling</span><span><i class="legend-dot refrigeration-ventilation"></i>Ventilation</span><span><i class="legend-dot refrigeration-safety"></i>Safety</span>`;$("#refrigerationMap").innerHTML=components.map(component=>{const outgoing=links.filter(([from])=>from===component.id);return `<article class="electrical-node refrigeration-node refrigeration-${component.view} ${activeRefrigerationComponent===component.id?"active":""}"><button data-refrigeration-component="${component.id}" aria-pressed="${activeRefrigerationComponent===component.id}"><span class="meta">${esc(component.category)}</span><strong>${esc(component.name)}</strong><small>${esc(component.operation)}</small></button>${outgoing.map(([,to,label])=>{const target=REFRIGERATION_COMPONENTS.find(item=>item.id===to);return `<button class="power-link" data-refrigeration-component="${to}"><span>${esc(label)}</span><b>→ ${esc(target?.name||to)}</b></button>`}).join("")}</article>`}).join("")||'<article class="panel"><p>No components match this view.</p></article>';renderRefrigerationInspector()}
...
function complianceReportData(){
  const snapshot=complianceSnapshot(),profile=state.vehicleProfile||{};return {...snapshot,vehicle:{make:profile.make||"Knaus",model:profile.model||"Sun Traveller",year:profile.year||"",registration:profile.registration||"",vin:profile.vin||"",mileage:Number(state.currentMileage)||0,evidence:vehicleEvidenceSnapshot()}};
}
...
function renderSeasonalTaskCopyButtons(){$$("[data-seasonal-custom-edit]").forEach(button=>button.insertAdjacentHTML("beforebegin",`<button class="secondary-btn" data-seasonal-custom-copy="${button.dataset.seasonalCustomEdit}">Copy</button>`))}
function setVisibleSeasonalTasksComplete(complete){const ids=new Set($$("#seasonalCustomTasks [data-seasonal-custom-toggle]").filter(button=>button.getAttribute("aria-checked")!==String(complete)).map(button=>button.dataset.seasonalCustomToggle));if(!ids.size){toast("No visible seasonal tasks need updating");return}const updatedAt=new Date().toISOString();state.seasonalCustomTasks=(state.seasonalCustomTasks||[]).map(item=>ids.has(item.id)?{...item,complete,updatedAt}:item);saveState();renderSeasonal();renderHome();toast(`${ids.size} seasonal ${ids.size===1?"task":"tasks"} ${complete?"completed":"reopened"}`)}
function resetSeasonalCustomTaskForm(){const form=$("#seasonalCustomTaskForm");form.reset();$("#seasonalCustomTaskId").value="";$("#seasonalCustomTaskMode").value=activeSeasonalMode;$("#seasonalCustomTaskSubmitLabel").textContent="Add task";$("#cancelSeasonalCustomTaskEdit").hidden=true}
function editSeasonalCustomTask(id){const item=(state.seasonalCustomTasks||[]).find(entry=>entry.id===id);if(!item)return;$("#seasonalCustomTaskId").value=item.id;$("#seasonalCustomTaskTitle").value=item.title;$("#seasonalCustomTaskMode").value=item.mode;$("#seasonalCustomTaskRoute").value=item.route;$("#seasonalCustomTaskPriority").value=item.priority||"normal";$("#seasonalCustomTaskDueDate").value=item.dueDate||"";$("#seasonalCustomTaskSubmitLabel").textContent="Save changes";$("#cancelSeasonalCustomTaskEdit").hidden=false;$("#seasonalCustomTaskTitle").focus()}
function duplicateSeasonalCustomTask(id){const item=(state.seasonalCustomTasks||[]).find(entry=>entry.id===id);if(!item)return;resetSeasonalCustomTaskForm();$("#seasonalCustomTaskTitle").value=`${item.title} copy`;$("#seasonalCustomTaskMode").value=item.mode;$("#seasonalCustomTaskRoute").value=item.route;$("#seasonalCustomTaskPriority").value=item.priority||"normal";$("#seasonalCustomTaskDueDate").value=item.dueDate||"";$("#seasonalCustomTaskSubmitLabel").textContent="Add copy";$("#cancelSeasonalCustomTaskEdit").hidden=false;$("#seasonalCustomTaskTitle").focus()}
function saveSeasonalCustomTask(event){event.preventDefault();const values=Object.fromEntries(new FormData(event.currentTarget)),title=values.title.trim(),existing=(state.seasonalCustomTasks||[]).find(item=>item.id===values.id),moved=Boolean(existing&&existing.mode!==values.mode);if(existing){state.seasonalCustomTasks=state.seasonalCustomTasks.map(item=>item.id===values.id?{...item,title,mode:values.mode,route:values.route,priority:values.priority||"normal",dueDate:values.dueDate||"",updatedAt:new Date().toISOString()}:item)}else{const item={id:`seasonal-custom-${Date.now()}`,mode:values.mode||activeSeasonalMode,title,route:values.route,priority:values.priority||"normal",dueDate:values.dueDate||"",complete:false,createdAt:new Date().toISOString()};state.seasonalCustomTasks=[item,...(state.seasonalCustomTasks||[])]}saveState();resetSeasonalCustomTaskForm();renderSeasonal();renderHome();toast(moved?"Custom task moved to another seasonal mode":existing?"Custom seasonal task updated":"Custom seasonal task added")}
...
function renderSeasonal(){
  ...
  renderSeasonalCustomTasks();renderSeasonalTaskCopyButtons();renderSeasonalCalendar();renderSeasonalHistory();
}
...
function configurationValue(field){
  if(Object.prototype.hasOwnProperty.call(state.vehicleConfiguration||{},field.id))return evidenceValue(state.vehicleConfiguration[field.id]);
  const profileValue=configurationProfileValue(field.id);
  return profileValue!==""?profileValue:field.value??"";
}
function configurationEvidence(field){
  if(Object.prototype.hasOwnProperty.call(state.vehicleConfiguration||{},field.id))return normaliseEvidence(state.vehicleConfiguration[field.id]);
  const profileValue=configurationProfileValue(field.id);return normaliseEvidence(profileValue!==""?profileValue:field.value??"",field.value!==undefined&&String(field.value).trim()?"manual-reference":"unknown");
}
function evidenceBadge(evidence){const item=normaliseEvidence(evidence),definition=EVIDENCE_STATUSES[item.status];return `<span class="evidence-badge evidence-${esc(item.status)}" data-evidence-status="${esc(item.status)}">${esc(definition.label)}</span>`}
function evidenceStatusOptions(selected){return Object.entries(EVIDENCE_STATUSES).sort((a,b)=>a[1].priority-b[1].priority).map(([value,item])=>`<option value="${value}" ${selected===value?"selected":""}>${esc(item.label)}</option>`).join("")}
function vehicleEvidenceSnapshot(){return {schemaVersion:2,statusDefinitions:EVIDENCE_STATUSES,configuration:Object.fromEntries(Object.entries(state.vehicleConfiguration||{}).map(([key,value])=>[key,normaliseEvidence(value)]))}}
function renderVehicleConfiguration(){
  ...
  const allFields=sections.flatMap(item=>item.fields||[]),evidence=allFields.map(configurationEvidence),confirmed=evidence.filter(item=>["owner-confirmed","photograph-confirmed","plate-confirmed"].includes(item.status)).length,uncertain=evidence.filter(item=>["estimated","unknown"].includes(item.status)).length;
  $("#configurationSummary").innerHTML=[[sections.length,"System sections"],[allFields.length,"Configuration fields"],[confirmed,"Confirmed values"],[uncertain,"Estimated or unknown"]].map(([v,l])=>`<article class="stat-card"><strong>${v}</strong><span>${l}</span></article>`).join("");
  ...
  $("#configurationFields").innerHTML=(section.fields||[]).map(field=>{
    const item=configurationEvidence(field),value=item.value;
    return `<article class="panel configuration-field evidence-card">${evidenceBadge(item)}<h3>${esc(field.label)}</h3><p>${esc(String(value).trim()||"Not recorded")}</p>${item.source||item.lastVerified||item.notes?`<details><summary>Evidence details</summary>${item.source?`<p><strong>Source:</strong> ${esc(item.source)}</p>`:""}${item.lastVerified?`<p><strong>Last verified:</strong> ${esc(formatTripDate(item.lastVerified))}</p>`:""}${item.notes?`<p><strong>Notes:</strong> ${esc(item.notes)}</p>`:""}</details>`:""}</article>`;
  }).join("");
...
function openConfigurationEditor(){
  ...
  $("#configurationFormFields").innerHTML=(section.fields||[]).map(field=>{
    const item=configurationEvidence(field),value=item.value,input=field.type==="select"?`<select name="${esc(field.id)}">${(field.options||[]).map(option=>`<option value="${esc(option)}" ${String(value)===String(option)?"selected":""}>${esc(option)}</option>`).join("")}</select>`:field.type==="textarea"?`<textarea name="${esc(field.id)}" maxlength="2000">${esc(value)}</textarea>`:`<input name="${esc(field.id)}" type="${field.type==="number"?"number":"text"}" value="${esc(value)}" ${field.type==="number"?'step="any"':""} maxlength="180">`;
    return `<fieldset class="configuration-evidence-editor trip-field-wide"><legend>${esc(field.label)}</legend><label>Value${input}</label><label>Evidence status<select name="${esc(field.id)}__status">${evidenceStatusOptions(item.status)}</select></label><label>Source<input name="${esc(field.id)}__source" value="${esc(item.source)}" maxlength="180"></label><label>Last verified<input name="${esc(field.id)}__lastVerified" type="date" value="${esc(item.lastVerified)}"></label><label class="trip-field-wide">Evidence notes<textarea name="${esc(field.id)}__notes" maxlength="500">${esc(item.notes)}</textarea></label></fieldset>`;
  }).join("")+'<p class="configuration-help trip-field-wide">Evidence metadata records why a value is trusted. Unknown and empty evidence details are valid.</p><div class="trip-form-actions trip-field-wide"><button class="secondary-btn" type="button" data-configuration-cancel>Cancel</button><button class="primary-btn" type="submit">Save configuration</button></div>';
...
function saveVehicleConfiguration(event){
  ...
  (section.fields||[]).forEach(field=>{const raw=String(values[field.id]??"").trim(),value=field.type==="number"&&raw!==""?Number(raw):raw;next[field.id]=normaliseEvidence({value,status:values[`${field.id}__status`],source:String(values[`${field.id}__source`]||"").trim(),lastVerified:String(values[`${field.id}__lastVerified`]||""),notes:String(values[`${field.id}__notes`]||"").trim()})});
  state.vehicleConfiguration=next;
  if(section.id==="identity"){
    const profile={...(state.vehicleProfile||{})};
    ["registration","vin","make","model","year","baseVehicle","length"].forEach(key=>{if(Object.prototype.hasOwnProperty.call(next,key))profile[key]=evidenceValue(next[key])});
    if(Object.prototype.hasOwnProperty.call(next,"mam"))profile.maxMass=evidenceValue(next.mam);
...
function renderWorkshop(){
  ...
  $("#workshopSystemButtons").innerHTML=[["electrical","⚡","Electrical"],["fuses","▥","Fuses"],["water","💧","Water"],["gas","🔥","Gas"],["heating","♨","Heating"],["refrigeration","❄","Refrigeration"],["diagnostics","🧰","Diagnostics"],["vehicle","📦","Parts & vehicle"]].map(([route,icon,label])=>`<button class="workshop-button" data-route="${route}"><span>${icon}</span><strong>${label}</strong></button>`).join("");
...
function exportBackup(){
  state.lastBackupExportedAt=new Date().toISOString();saveState();
...
function parseBackupText(text){
  ...
  const incoming=payload?.state||payload;if(!incoming||typeof incoming!=="object"||Array.isArray(incoming))throw new Error("Backup structure is invalid. No data was changed.");if(incoming.maintenancePlans!==undefined&&!Array.isArray(incoming.maintenancePlans))throw new Error("Backup maintenance plans are invalid. No data was changed.");if(Array.isArray(incoming.maintenancePlans)&&globalThis.KnausMaintenanceEngine&&incoming.maintenancePlans.some(item=>!globalThis.KnausMaintenanceEngine.validate(item).valid))throw new Error("Backup contains invalid maintenance plans. No data was changed.");if(incoming.trips!==undefined&&!Array.isArray(incoming.trips))throw new Error("Backup trips are invalid. No data was changed.");if(Array.isArray(incoming.trips)&&globalThis.KnausTrips&&incoming.trips.filter(item=>/^TR-/.test(item?.id||"")).some(item=>!globalThis.KnausTrips.validate(item).valid))throw new Error("Backup contains invalid managed trips. No data was changed.");if(incoming.workshopJobs!==undefined&&!Array.isArray(incoming.workshopJobs))throw new Error("Backup workshop jobs are invalid. No data was changed.");if(Array.isArray(incoming.workshopJobs)&&globalThis.KnausWorkshopJobs&&incoming.workshopJobs.some(job=>!globalThis.KnausWorkshopJobs.validate(job).valid))throw new Error("Backup contains invalid workshop jobs. No data was changed.");if(incoming.inspections!==undefined&&!Array.isArray(incoming.inspections))throw new Error("Backup inspections are invalid. No data was changed.");if(Array.isArray(incoming.inspections)&&globalThis.KnausInspections&&incoming.inspections.some(item=>!globalThis.KnausInspections.validate(item).valid))throw new Error("Backup contains invalid inspections. No data was changed.");if(incoming.changePlans!==undefined&&!Array.isArray(incoming.changePlans))throw new Error("Backup change plans are invalid. No data was changed.");if(Array.isArray(incoming.changePlans)&&globalThis.KnausChangePlans){const invalidPlans=incoming.changePlans.filter(plan=>!globalThis.KnausChangePlans.validate(plan).valid);if(invalidPlans.length)throw new Error(`Backup contains ${invalidPlans.length} invalid change plan${invalidPlans.length===1?"":"s"}. No data was changed.`)}if(incoming.ownerRecords!==undefined&&!Array.isArray(incoming.ownerRecords))throw new Error("Backup owner records are invalid. No data was changed.");if(incoming.evidenceLibrary!==undefined&&!Array.isArray(incoming.evidenceLibrary))throw new Error("Backup evidence metadata is invalid. No data was changed.");if(Array.isArray(incoming.ownerRecords)&&globalThis.KnausOwnerRecords){const ids=incoming.ownerRecords.map(record=>record.id),invalid=incoming.ownerRecords.filter(record=>!globalThis.KnausOwnerRecords.validate(record,{knownRecordIds:ids}).valid);if(invalid.length)throw new Error(`Backup contains ${invalid.length} invalid owner record${invalid.length===1?"":"s"}. No data was changed.`)}if(Array.isArray(incoming.evidenceLibrary)&&globalThis.KnausEvidenceLibrary){const invalid=incoming.evidenceLibrary.filter(record=>!globalThis.KnausEvidenceLibrary.validate(record).valid);if(invalid.length)throw new Error(`Backup contains ${invalid.length} invalid evidence record${invalid.length===1?"":"s"}. Binary files are not included and no data was changed.`)}
...
async function restoreBackup(file){
  ...
  const owner=restored.ownerRecords||[],counts={service:(restored.logs||[]).length,faults:(restored.faults||[]).length,trips:(restored.trips||[]).length,measurements:(restored.electricalMeasurements||[]).length,ownerRecords:owner.length,ownerFaults:owner.filter(x=>x.type==="fault").length,ownerMaintenance:owner.filter(x=>["maintenance","service"].includes(x.type)).length,modifications:owner.filter(x=>x.type==="modification").length,ownerMeasurements:owner.filter(x=>x.type==="measurement").length,archived:owner.filter(x=>x.archived).length,evidenceLinks:(restored.evidenceLinks||[]).length,revisions:owner.reduce((sum,x)=>sum+(x.history?.length||0),0)};
...
async function rebuildCache(){
  ...
  const button=$("#healthRebuildCache"),detail=$("#healthCacheDetail");button.disabled=true;button.textContent="Rebuilding…";detail.textContent="Caching the release shell. Keep this page open…";
  try{
    if("caches" in window){const keys=await caches.keys();await Promise.all(keys.map(key=>caches.delete(key)))}
    const registration=await navigator.serviceWorker?.getRegistration();if(!registration?.active)throw new Error("service worker unavailable");const channel=new MessageChannel(),completion=new Promise((resolve,reject)=>{const timer=setTimeout(()=>reject(new Error("cache rebuild timed out")),20000);channel.port1.onmessage=event=>{clearTimeout(timer);event.data?.ok?resolve():reject(new Error("cache rebuild failed"))}});registration.active.postMessage({type:"REBUILD_CACHE"},[channel.port2]);await completion;await registration.update();
    toast("Offline cache cleared for rebuild. Reloading…");setTimeout(()=>location.reload(),700);
  }catch{button.disabled=false;button.textContent="Rebuild cache";detail.textContent="Cache rebuild failed. Check the connection and try again.";toast("The offline cache could not be rebuilt. Your saved records were not changed.")}
}
async function init(){
  [
  ...
  window.KnausChangePlannerUI?.initialise({toast});window.KnausWorkshopJobsUI?.initialise({toast});window.KnausTripsUI?.initialise({toast});window.KnausMaintenanceIntelligenceUI?.initialise({toast});window.KnausOwnershipIntelligenceUI?.initialise({adapter:ownerAdapter,toast});window.KnausOwnershipProfileUI?.initialise({adapter:ownerAdapter,toast});
  ...
  setActiveRoute(document.querySelector(`[data-screen="${CSS.escape(route())}"]`)?route():"home");
}
document.addEventListener("click",e=>{
  ...
  if(e.target.closest("#saveAssistantAsRecord")){const latest=state.assistantHistory?.[0];window.KnausOwnerRecordUI?.open({type:"observation",title:latest?.question||"Assistant observation",description:latest?.answer||"",status:"draft",confidence:"unknown",provenance:"owner-observation",occurredAt:new Date().toISOString(),notes:"Saved explicitly from the local assistant; review and add direct evidence before confirming."})}
  ...
  const electricalMeasurementFilterButton=e.target.closest("[data-electrical-measurement-filter]");if(electricalMeasurementFilterButton){electricalMeasurementFilter=electricalMeasurementFilterButton.dataset.electricalMeasurementFilter;renderElectrical()}
  ...
  const electricalMeasurementDelete=e.target.closest("[data-electrical-measurement-delete]");if(electricalMeasurementDelete)deleteElectricalMeasurement(electricalMeasurementDelete.dataset.electricalMeasurementDelete);
  ...
  const heatingRunFilterButton=e.target.closest("[data-heating-run-filter]");if(heatingRunFilterButton){heatingRunFilter=heatingRunFilterButton.dataset.heatingRunFilter;renderHeatingRuns()}
  const heatingRunDelete=e.target.closest("[data-heating-run-delete]");if(heatingRunDelete)deleteHeatingRun(heatingRunDelete.dataset.heatingRunDelete);
  const heatingServiceDelete=e.target.closest("[data-heating-service-delete]");if(heatingServiceDelete)deleteHeatingServiceRecord(heatingServiceDelete.dataset.heatingServiceDelete);
  const refrigerationFilterButton=e.target.closest("[data-refrigeration-filter]");if(refrigerationFilterButton){refrigerationFilter=refrigerationFilterButton.dataset.refrigerationFilter;const first=refrigerationComponents()[0];if(first)activeRefrigerationComponent=first.id;renderRefrigeration()}
  const refrigerationComponent=e.target.closest("[data-refrigeration-component]");if(refrigerationComponent){activeRefrigerationComponent=refrigerationComponent.dataset.refrigerationComponent;renderRefrigeration()}
  const refrigerationReadiness=e.target.closest("[data-refrigeration-readiness]");if(refrigerationReadiness)toggleRefrigerationReadiness(refrigerationReadiness.dataset.refrigerationReadiness);
  const refrigerationRunDelete=e.target.closest("[data-refrigeration-run-delete]");if(refrigerationRunDelete)deleteRefrigerationRun(refrigerationRunDelete.dataset.refrigerationRunDelete);
  const refrigerationRunFilterButton=e.target.closest("[data-refrigeration-run-filter]");if(refrigerationRunFilterButton){refrigerationRunFilter=refrigerationRunFilterButton.dataset.refrigerationRunFilter;renderRefrigerationRuns()}
  ...
  const seasonalCustomFilter=e.target.closest("[data-seasonal-custom-filter]");if(seasonalCustomFilter){seasonalCustomTaskFilter=seasonalCustomFilter.dataset.seasonalCustomFilter;renderSeasonalCustomTasks();renderSeasonalTaskCopyButtons()}
  ...
  const seasonalCustomCopy=e.target.closest("[data-seasonal-custom-copy]");if(seasonalCustomCopy)duplicateSeasonalCustomTask(seasonalCustomCopy.dataset.seasonalCustomCopy);
...
$("#completeVisibleSeasonalTasks").onclick=()=>setVisibleSeasonalTasksComplete(true);
$("#reopenVisibleSeasonalTasks").onclick=()=>setVisibleSeasonalTasksComplete(false);
$("#heatingProfileForm").addEventListener("submit",saveHeatingProfile);
$("#heatingServiceForm").addEventListener("submit",saveHeatingServiceSchedule);
$("#recordHeatingService").onclick=recordHeatingService;
$("#exportHeatingServiceCalendar").onclick=exportHeatingServiceCalendar;
$("#refrigerationProfileForm").addEventListener("submit",saveRefrigerationProfile);
$("#refrigerationRunForm").addEventListener("submit",saveRefrigerationRun);
$("#exportRefrigerationRuns").onclick=exportRefrigerationRunsCsv;
$("#exportRefrigerationEvidence").onclick=exportRefrigerationEvidence;
$("#printRefrigerationReport").onclick=printRefrigerationReport;
...
$("#printElectricalReport").onclick=printElectricalReport;
$("#exportElectricalMeasurements").onclick=exportElectricalMeasurementsCsv;
$("#electricalMeasurementForm").addEventListener("submit",saveElectricalMeasurement);
