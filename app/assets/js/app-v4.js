...
const NAV=[
  ["workshop-jobs","Workshop Jobs","W"],["inspections","Inspections","I"],
...
async function init(){
  ...
  window.KnausChangePlans?.initialise(ownerAdapter);window.KnausWorkshopJobs?.initialise(ownerAdapter);window.KnausInspections?.initialise(ownerAdapter,{templates:DATA.inspectionTemplates||[]});window.KnausTrips?.initialise(ownerAdapter);window.KnausMaintenanceEngine?.initialise(ownerAdapter);window.KnausMaintenanceCampaigns?.initialise(ownerAdapter);window.KnausMaintenanceParts?.initialise(ownerAdapter);window.KnausMaintenanceConsumables?.initialise(ownerAdapter);window.KnausMaintenanceWarranty?.initialise(ownerAdapter);
  ...
  window.KnausChangePlannerUI?.initialise({toast});window.KnausWorkshopJobsUI?.initialise({toast});window.KnausTripsUI?.initialise({toast});window.KnausMaintenanceIntelligenceUI?.initialise({toast});
